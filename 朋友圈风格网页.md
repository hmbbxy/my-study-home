# 朋友圈背景
在top中添加一个img元素作为朋友圈的背景。

为了防止图片过大，无法完全显示，我们将它的宽度限制在500px。
# 昵称与头像
在第15行，创建一个类名为head的div元素，用来存储昵称和头像。

第16行，添加一个p元素表示昵称；

第17行，添加一个img元素表示头像，其宽度为80px；
# 为朋友圈中的每个div元素都设置了一个类名
例如container、top等。
...
2、标记出每个div元素的意义，帮助我们快速理清代码结构。

# 分析页面
朋友圈可以展示多条动态，但每条动态的结构如图所示分为左右两个部分：
        ...
        <div class="bottom">
            ...
            <div class="new">
                ...
                <div class="comment">
                    ...
                    <!-- 回复 -->
                    <div class="reply">
                        <p><span>小黄Buggy：</span>在哪里学的，我也要学</p>
                    </div>
                </div>
            </div>
            <!--第二条动态-->
